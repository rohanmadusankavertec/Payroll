...
import com.sumaga.daoimpl.PrivilegeDAOImpl;
import com.sumaga.daoimpl.UserDAOImpl;
...
public class PrivilegeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            ...
            //Open User Group Privilege Page
            case "LoadUserGroups": {
            ...
            //View Update User group Privilege Page
...
//                List<Integer> newAr = new ArrayList<Integer>();
            ...
            //Open Privilege Registration Page
