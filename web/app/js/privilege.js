...
function viewUserDetails2(prgid) {
    ...
    xmlHttp.onreadystatechange = function ()
    {
        if (xmlHttp.readyState === 4 && xmlHttp.status === 200)
        {
            ...
            var privilege = document.getElementById('privilegemanage');
            var product = document.getElementById('productmanage');
            var branch = document.getElementById('branchmanage');
            var vehicle = document.getElementById('vehiclemanage');
            var stock = document.getElementById('stockmanage');
            var sales = document.getElementById('salesManage');
            var payment = document.getElementById('paymentManage');
            
            var supplier = document.getElementById('supplierManage');
            var po = document.getElementById('poManage');
            var grn = document.getElementById('grnManage');
            var warehouse = document.getElementById('warehouseManage');
