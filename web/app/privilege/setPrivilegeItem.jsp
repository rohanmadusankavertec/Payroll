 ...
 */
--%>
<%@page import="com.sumaga.hibe.model.UserGroup"%>
            ...
            <div class="hidden" id="permissiondiv">
                ...
                <div class="x_content" id="allPutty">
                    ...
                    <div class="col-lg-4">
                        <div class="x_panel tile" style="height: 300px;">
                            <div class="x_title">
                                <h2>Allowance & Deductions Management</h2>
                            ...
                            <div class="x_content" id="vehiclemanage">
                    ...
                    <div class="col-lg-4">
                        <div class="x_panel tile" style="height: 300px;">
                            ...
                            <div class="x_content" id="salesManage">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="x_panel tile" style="height: 700px;">
                            <div class="x_title">
